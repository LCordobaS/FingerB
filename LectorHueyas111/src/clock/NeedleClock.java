               ...
               ImageObserver
{
  ...
  int xCen, yCen, radius;   // Circulo horario
  volatile Thread timer = null;  // Temporizador
  boolean isPM = false;     // Pasado mediodia?
  ...
  public void run ()
  {
    ...
    // Segundos de diferencia por zona horaria y tambien por horario de verano/invierno
